        ...
        <main className="pt-24 pb-20">
          ...
          <section className="relative py-16 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
              ...
              >
                <Activity className="w-4 h-4" /> Recorrido Actualizado
              </motion.div>
              <motion.h1
              ...
              >
                Ruta de <span className="text-gradient-emerald">10 Kilómetros</span>
              </motion.h1>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4 mb-8">
            ...
            {/* Contenedor con los nuevos mapas */}
                  ...
                  {activeMap === "mapmyrun" ? (
                    ...
                    >
                      <iframe
                        ...
                        src='https://www.mapmyrun.com/routes/view/embedded/5556729535?width=600&height=376&elevation=true&info=true&line_color=E61900DC&rgbhex=DC0019&distance_markers=0&unit_type=imperial&map_mode=ROADMAP&show_marker_every=1&last_updated=2023-08-13T01:43:32+00:00'
                        className="w-full h-full border-0"
                      />
                      <div className="bg-card p-4 flex justify-between items-center border-t border-border">
                        <span className="text-sm font-medium text-muted-foreground">Datos: MapMyRun #5556729535</span>
                        <a href="https://www.mapmyrun.com/routes/view/5556729535" target="_blank" className="text-primary flex items-center gap-1 text-sm font-bold hover:underline">
                          Ver detalles de la ruta <ExternalLink className="w-4 h-4" />
                        </a>
                      </div>
                    </motion.div>
                  ) : (
                    ...
                    >
                      <iframe
                        src="https://www.google.com/maps/d/embed?mid=1lLFf3piNJOjpvSRpwIhcsYGo31sBBuo&ehbc=2E312F"
                        className="w-full h-full border-0"
                        allowFullScreen
                      />
                    </motion.div>
